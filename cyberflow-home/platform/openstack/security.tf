...
resource "openstack_networking_secgroup_rule_v2" "ssh_rule" {
  ...
  port_range_min    = 22
  port_range_max    = 22
  remote_group_id = openstack_networking_secgroup_v2.ssh.id
...
resource "openstack_networking_secgroup_rule_v2" "www_rule_80" {
  ...
  port_range_min    = 80
  port_range_max    = 80
  remote_group_id = openstack_networking_secgroup_v2.www.id
...
resource "openstack_networking_secgroup_rule_v2" "mail_rule_25" {
  ...
  port_range_min    = 25
  port_range_max    = 25
  remote_group_id = openstack_networking_secgroup_v2.mail.id
